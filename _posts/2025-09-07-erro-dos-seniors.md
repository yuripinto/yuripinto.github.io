...
Se voltarmos para as raízes do DevOps, os primeiros papers falavam em dar os problemas operacionais para serem automatizados pelos desenvolvedores. Os sêniors, sem dúvida, são os melhores para fazer isso.